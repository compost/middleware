...
public class SqsProcessorTest {
  ...
  public void testProcessorPlayer() {
    ...
    processor.process(new Record<>("1-p1",
        """
            {"player_id":"p1","brand_id":"1","country_alpha_2_code":"JP"}""".getBytes(), 0L));
    ...
    Assertions.assertEquals(
        """
            {"type":"GENERIC_USER","contactId":"p1","mappingSelector":"player_registration","properties":{"originalId":"p1","player_id":"p1","country_alpha_2_code":"JP","brand_id":"1"}}""",
        messages.get(0).body());
  }
  ...
  public void testProcessorPlayerFirstDepDatetimeTwice() {
    ...
    processor.process(new Record<>("1-p1",
        """
            {"player_id":"p1","brand_id":"1","first_dep_datetime":"2029-09-12Tddd", "country_alpha_2_code":"FR"}"""
            .getBytes(),
        0L));
    ...
    Assertions.assertEquals(
        """
            {"type":"GENERIC_USER","contactId":"p1","mappingSelector":"player_updated","properties":{"originalId":"p1","player_id":"p1","first_dep_datetime":"2029-09-12","country_alpha_2_code":"FR","brand_id":"1"}}""",
        messages.get(2).body());
  }
  ...
  public void testProcessorPlayer_DEV() {
    ...
    processor.process(new Record<>("2-p1",
        """
            {"player_id":"p1","brand_id":"2","country_alpha_2_code":"JP"}""".getBytes(), 0L));
    ...
    Assertions.assertEquals(
        """
            {"type":"GENERIC_USER","contactId":"p1","mappingSelector":"DEV_player_registration","properties":{"originalId":"p1","player_id":"p1","country_alpha_2_code":"JP","brand_id":"2"}}""",
        messages.get(0).body());
  }
