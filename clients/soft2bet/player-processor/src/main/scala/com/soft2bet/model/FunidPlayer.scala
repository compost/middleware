...
case class FunidPlayerRegisteredSQS(
...
case class FunidPlayerLoginSQS(
    originalId: Option[String],
    brandId: Option[String],
    lastlogindate: String
)

object FunidPlayerStore {

  def apply(
      previous: Option[FunidPlayerStore],
      player: FunidPlayer
  ): FunidPlayerStore = {
    previous match {
      case Some(p) =>
...
object FunidPlayerRegisteredSQS {
  def apply(
      player: FunidPlayerStore
  ): FunidPlayerRegisteredSQS = {
    FunidPlayerRegisteredSQS(
