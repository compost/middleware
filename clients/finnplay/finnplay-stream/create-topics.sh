...
/usr/hdp/current/kafka-broker/bin/kafka-topics.sh --bootstrap-server ${BOOTSTRAP_SERVER} --create --topic ${PREFIX}-user-consent-update-finnplay-repartitioned --partitions 12 --replication-factor 2
